...
const url = "mongodb+srv://Shriyash:shriyash1a2b@cluster0.1laezrl.mongodb.net/Yearbook10?retryWrites=true&w=majority";

const dbName = "Yearbook10"
const client = new MongoClient(url);
app.get("/",function(req,res){
    const db = client.db(dbName)
    const collection = db.collection('items')
    collection.find({}).toArray(function(err,items_list){
...
client.connect(function(err){
  ...
  app.get("/student/:customListName",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("list2",{'Items':items_list,listName:customListName,student_name:student_name})
    })
  })
  ...
  app.get("/professor",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("professor_ID",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/prachi",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("prachi",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/manasi",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("pmanasi",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/cn_pandey",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("cn_pandey",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/Soumyabrata",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("Soumyabrata",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/jooyoung",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("jooyoung",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/rraghvan",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("rraghvan",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/saumils",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("saumils",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/spm",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("spm",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/satyajit",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("satyajit",{'Items':items_list,'prof':prof})
    })
  })
  app.get("/professor/mayank",function(req,res){
    ...
    collection.find({}).toArray(function(err,items_list){
        assert.equal(err,null);
        res.render("mayank",{'Items':items_list,'prof':prof})
    })
  })
